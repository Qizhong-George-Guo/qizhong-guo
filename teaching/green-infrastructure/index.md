...
<p style="font-size:1.2em; font-weight:bold; margin-top:-1em;">(Stormwater Focused)</p>
...
## Lecture Materials
### Outline
- [Course Outline (PDF)](/files/teaching/green-infrastructure/Course_Outline-Green_Infrastructure-Fall_2026.pdf){:target="_blank"}
...
- [GGBI Watershed Resilience Presentation (PDF)](/files/teaching/green-infrastructure/GGBI_Watershed_Resilience.pdf){:target="_blank"}
...
- [Briefing Document (PDF)](/files/teaching/green-infrastructure/Topic_I-8_Soil_Erosion_Control_(Briefing_Document).pdf){:target="_blank"}
...
- [Briefing Document (PDF)](/files/teaching/green-infrastructure/Topic_I-10_Design_Procedures_(Briefing_Document).pdf){:target="_blank"}
...
- [Slide Deck (PDF)](/files/teaching/green-infrastructure/Topic_V-Sustainability_(Slide_Deck).pdf){:target="_blank"}
- [Infographic (PDF)](/files/teaching/green-infrastructure/Topic_V-Sustainability_(Infographic).pdf){:target="_blank"}


*The course materials on this page are being updated as I teach this course again in Fall 2026. The briefing document, slide deck, and infographic linked above were initially generated using NotebookLM based on my original Fall 2024 lecture slides. Topic I-3, Stormwater Rules, was updated in late January 2026, and additional course content is being revised and expanded during the Fall 2026 semester.*
