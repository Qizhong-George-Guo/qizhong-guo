...
Liulan Reservoir is an older medium-sized reservoir with a homogeneous earth-fill dam constructed in the late 1950s. The event appears to have been triggered by extreme inflow that exceeded the reservoir’s effective flood-handling capacity. Once overtopping occurred, the downstream face of the earth dam would have been highly vulnerable to erosion, headcutting, and breach enlargement.
...
六蓝水库是一座建于20世纪50年代末的中型水库，主坝为均质土坝。此次事件的直接触发因素可能是极端暴雨造成的超标准入库洪水，超过了水库在当时条件下的有效泄洪和调蓄能力。一旦发生漫顶，均质土坝下游坡面极易受到集中水流冲刷，进而形成冲沟、溯源侵蚀和缺口扩大。
...
**Download:**  
[Chinese version of this brief （技术简报中文版下载） →](/files/reflections/Technical_Review_Liulan_Reservoir_Overtopping_Local_Breach_in_Chinese.pdf){:target="_blank"}  
